...
const rawUseCaseDatabase = [
    ...
    },
    {
        ...
        description: 'Improves power and gas trading outcomes by combining demand forecasts, market signals, and contract constraints to recommend schedules and hedging actions.',
        vertical: 'energy',
        ...
        agentArchitecture: {
            ...
            overview: 'Combines structured market and position data with policy constraints to generate scenario-based dispatch and hedging recommendations with explainable rationale.',
            components: [
            ...
            dataFlow: 'Market Feeds/ERP → Data Lake + SQL → Scenario Simulation → Risk Scoring → Trader Recommendations → Approval and Audit Trail',
        },
        implementation: {
            phase1: [
    ...
    },
    {
        ...
        description: 'Correlates pipeline telemetry, inspection findings, and maintenance history to prioritize integrity actions and accelerate leak response coordination.',
        vertical: 'gas',
        ...
        agentArchitecture: {
            ...
            overview: 'Blends real-time telemetry, inspection data, and incident procedures to identify elevated integrity risks and orchestrate response playbooks.',
            components: [
            ...
            dataFlow: 'SCADA/Historian + Inspection Records → Risk Correlation → Priority Queue → Response Playbook → Work Orders and Compliance Logs',
        },
        implementation: {
            phase1: [
    ...
    },
    {
        ...
        description: 'Supports utility service teams with outage insights, billing resolution guidance, and proactive customer communications to reduce escalations.',
        vertical: 'energy',
        ...
        agentArchitecture: {
            ...
            overview: 'Fuses CRM, outage, and billing signals to provide service agents with context-rich recommendations and consistent communications.',
            components: [
            ...
            dataFlow: 'CRM + Billing + Service Events → Context Assembly → Recommendation Generation → Agent Workflow → Resolution and Feedback Loop',
        },
        implementation: {
            phase1: [
...
function buildPersonaList(useCase) {
    const personas = new Set([...REQUIRED_PERSONAS]);
    if (Array.isArray(useCase.personas)) {
        useCase.personas
            .filter((persona) => typeof persona === 'string' && persona.length > 0)
    ...
    const order = new Map(REQUIRED_PERSONAS.map((persona, index) => [persona, index]));
...
export const useCaseDatabase = rawUseCaseDatabase.map((useCase) => ({
    ...useCase,
