...
function generateHybridRecommendation(scoringResult) {
    ...
    const maxScore = Math.max(scores.m365Copilot, scores.copilotStudio, scores.foundry, scores.agentBuilder);
    ...
    return {
            ...
            ? [
                {
                    ...
                    context: 'Both platforms scored competitively for your scenario, indicating overlap in capabilities. They both support custom agent development, multi-turn conversations, and integration with enterprise data. Here is how to decide:',
                    factors: [
                        {
                        ...
                        },
                        {
                            ...
                            foundry: 'Full control: fine-tune models, use custom models, adjust hyperparameters',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            foundry: 'Full control: Azure AI Search, custom embeddings, vector stores, chunking strategies',
                        },
                        {
        ...
        licensingBreakdown: {
            description: 'Hybrid approach licensing is complex because each platform has different pricing models. Here is how to estimate total cost:',
            platforms: [
                competitivePlatforms.m365
                    ? {
                        ...
                        notes: 'Required for broad productivity deployment. Includes zero-rated access to Copilot Studio agents when accessed via M365 Copilot, Teams, or SharePoint.',
                ...
                competitivePlatforms.foundry || foundryStudioOverlap
                    ? {
                        ...
                        notes: 'Cost depends on model choice (GPT-4, GPT-4o, custom), usage volume, and infrastructure footprint. PTU ($6.50/hour/100k tokens) recommended for predictable high-volume workloads.',
                        example: 'Custom AI application with 1M GPT-4o tokens/month = ~$60/month (tokens) + $200/month (App Service, AI Search, storage) = $260/month total. High-volume scenarios with PTU = $4,680/month (PTU) + infrastructure.',
                    }
                    : null,
                competitivePlatforms.agentBuilder
                    ? {
